...
| 5 | **AI buton seti:** [00-kararlar-ve-sozluk.md](00-kararlar-ve-sozluk.md) [Onayla] [Düzenle] [İptal]; D02 ve D06'da eski setler olabilir. | Kimlikler `order:{id}:confirm\|edit\|cancel` (§4.2); 02 ve 06 kanonik sete hizalanmalı. |
...
| 17 | **Kurye girişi.** | **Karara bağlandı** ([00-kararlar-ve-sozluk.md](00-kararlar-ve-sozluk.md) §4): magic link tek kullanımlık ve 15 dk içinde açılmalı; açılınca oturum 12 saat (vardiya). D04 §7.11/§9.1'deki "oturum 7 gün" ifadeleri 12 saate çevrilmeli. |
...
| 21 | **Impersonation uzatması:** D05 A-09 "bir kez uzatılır, toplam en fazla 60 dk" diyor. | [00-kararlar-ve-sozluk.md](00-kararlar-ve-sozluk.md) §4 "en fazla 30 dk" uygulandı: uzatma yok, gerekirse yeni gerekçeyle yeni oturum. D05 düzeltilmeli. |
| 22 | **Manuel siparişte bölge dışı istisnasının yetkisi:** [00-kararlar-ve-sozluk.md](00-kararlar-ve-sozluk.md) §4 "personel" diyor (O/M/C); D04 §4.13 ve §15 #7 yalnız `owner`/`manager` öneriyor. | [00-kararlar-ve-sozluk.md](00-kararlar-ve-sozluk.md) uygulandı (O/M/C, audit'li `out_of_zone_override`). Daraltılması istenirse [00-kararlar-ve-sozluk.md](00-kararlar-ve-sozluk.md) §4 güncellenmeli. |
