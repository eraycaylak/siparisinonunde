...
- **Karşılama sıklığı:** tam karşılama (menü linkli) aynı müşteriye en fazla 12 saatte bir; arada gelen mesajlara kısa yanıt + "Menüyü aç" en fazla 30 dk'da bir; açık siparişi olan müşteriye karşılama yerine sipariş durumu kartı gider.
...
- **Takip token'ı:** `orders.tracking_token` HMAC ile türetilir (gerektiğinde yeniden üretilebilir; 07 §1.2); süresi `tracking_expires_at` = teslim/final durum + 7 gün; süresi dolmuş link 410 döner ve yalnız kişisel veri içermeyen özet gösterir.
