...
Karara bağlanan maddeler "Karara bağlandı" diye kapatılmıştır; numaralar önceki taslakla aynı tutuldu. Proje sahibine sorulacak kararlar [00-kararlar-ve-sozluk.md](00-kararlar-ve-sozluk.md) §13'e bağlanmıştır.
...
| 11 | **M13 zamanlaması ve sistem iptali.** | **Karara bağlandı** ([00-kararlar-ve-sozluk.md](00-kararlar-ve-sozluk.md) §10 alarm zinciri ve koordinatör kuralı): otomatik iptal süresi işletme ayarı, 10–30 dk aralığında, varsayılan 15 dk; müşteriye bilgi (M13 + takip sayfası satırı) varsayılan t=10 dk'da ve her durumda iptalden **en az 5 dk önce** gider (§9.2 M13, K17). "Beklerim" süreyi uzatmaz. 00 §10'a "10–30 dk" ve "en az 5 dk önce" sınırları eklenmeli. |
