...
| 4 | **Alarm zinciri zamanlaması.** | **Karara bağlandı:** [00-kararlar-ve-sozluk.md](00-kararlar-ve-sozluk.md) §10 kanonik zamanlama (t = 0 ses + Web Push, 60 sn ses tekrarı, 2 dk platform WhatsApp, 5 dk SMS, 10 dk müşteriye bilgi, 15 dk `cancelled`) §7.2 ve S9'da aynen kullanıldı; [07](07-veri-modeli-ve-api.md) `alarm_escalations.step` 1–6 bu sırayla numaralanır. Açık kalan: [02](02-whatsapp-entegrasyonu.md) §10.3 hâlâ Web Push'u T+1 dk'da gösteriyor; 00'a göre düzeltilmeli. |
...
| 20 | **WhatsApp'sız modda Akış B yedeği.** | **Karara bağlandı:** [00-kararlar-ve-sozluk.md](00-kararlar-ve-sozluk.md) §7: SMS OTP yedeği **Faz 1** ("WhatsApp'sız mod"); bu dokümanda uygulandı (§1, R06, R23, §5.5 Kapı 1, §5.8, RB-2), [06](06-teknik-mimari.md) §13.6 ve [01](01-vizyon-pazar-is-modeli.md) buna göre hizalandı. Açık kalan: SMS adil kullanım kotası (Esnaf 100, Pro 300 SMS/ay, [00-kararlar-ve-sozluk.md](00-kararlar-ve-sozluk.md) §4) ve SMS pompalama limitleri ([06](06-teknik-mimari.md) §15.4) pilot verisiyle gözden geçirilmeli. |
| 21 | **Kill switch adları:** [00-kararlar-ve-sozluk.md](00-kararlar-ve-sozluk.md) §4'teki kanonik liste `signup_open`, `wa_onboarding`, `campaigns_global`, `llm_parsing`, `sms_fallback`, tenant bazında `ordering_enabled`. | Bu doküman bu adları kullanır (R34, RB-2); `platform_wa_alerts` bir `ops` bayrağıdır ([07](07-veri-modeli-ve-api.md) §3.7). Açık kalan: [06](06-teknik-mimari.md) §16.6 hâlâ eski listeyi (`ai_ordering`, `akis_b_wa_verification`…) kill switch diye veriyor; 00'a göre düzeltilmeli. |
