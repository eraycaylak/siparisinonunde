...
| **D4** Teşvik A/B | H3 | D3 içinde 3 kart varyantı: (a) ücretsiz içecek, (b) %10 indirim, (c) dijital damga "10. sipariş bedava" | Varyant başına kart→sipariş ve işletmeye maliyet | En iyi varyant pilot kitine girer (küçük örneklem: yön gösterir, istatistiksel kanıt değildir) | D3 ile | Teşvik bedeli (işletme) | Kurucu-İş |
