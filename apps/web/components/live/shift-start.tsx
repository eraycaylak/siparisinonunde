...
import { CircleCheck, CircleX, Play, Volume2, Wifi } from 'lucide-react';
...
export function ShiftStart({
  ...
  return (
    <div role="dialog" aria-modal="true" aria-labelledby="vardiya-baslik" className="fixed inset-0 z-[80] flex items-center justify-center bg-surface p-4">
      <div className="flex w-full max-w-xl flex-col items-center gap-6 rounded-xl border border-border bg-surface-raised p-6 text-center shadow-lg sm:p-10">
